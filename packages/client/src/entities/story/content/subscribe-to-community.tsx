    ...
    return (
        <div className={"bg-[#FF3B73] flex justify-between relative text-white"}>
            <motion.div
                ...
                className={"w-full h-full absolute z-10 pointer-events-none touch-none"}
            >
                <motion.img
                    animate={controls}
            ...
            <div className={"flex flex-col font-vk-sans z-20 pointer-events-none touch-none"}>
                <div
                    style={{
            ...
            <Div className={"absolute bottom-0 w-full box-border mb-safe-area-bottom z-20"}>
                <Button
